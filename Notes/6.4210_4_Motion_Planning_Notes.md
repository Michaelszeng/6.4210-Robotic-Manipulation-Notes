...
Multi-dimensional Bezier curves are very similar, won't go into detail, but thye just have multiple parameters $t$ (i.e. $C(t_1, t_2)$ for a 2D "Bezier Surface"). You then also need $(n+1)^d$ control points, where $d$ is the number of dimensions.
